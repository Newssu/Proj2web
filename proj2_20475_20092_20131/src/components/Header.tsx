      ...
      <div className="flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/dictionary"
              className="rounded-xl px-3 py-2 border border-emerald-200/70 bg-white/70 hover:bg-emerald-100 transition font-semibold dark:bg-gray-800/70 dark:border-gray-700 dark:hover:bg-gray-700"
            >
              📘 พจนานุกรมต้นไม้
            </Link>
